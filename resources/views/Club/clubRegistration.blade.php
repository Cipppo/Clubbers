              ...
              <div class="text-center">
                ...
                <form class="mt-8 space-y-6" method="POST" action="/create-club" enctype="multipart/form-data">
                  ...
                  <div class="mt-8 content-center">
                    ...
                    <input class="block w-full mb-5 text-xs text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" id="choose-file" type="file" accept="image/png, image/jpeg" name="choose-file">
                  </div>
                </div>
                <div id="Part2">
                  <h2 class="mt-6 text-3xl font-bold text-gray-900" id="regTitle">
