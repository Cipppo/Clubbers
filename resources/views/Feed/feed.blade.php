...
<<<<<<< HEAD
                    <img class ="rounded-t-lg " src="images/Banner1.jpg" alt="banner">
                </div>
                <div class="post-Profile flex items-center gap-2 p-2">
                    <img class="post-profilePicture object-fill h-20 w-20  rounded-full" src="images/Banner1.jpg" alt="profile picture">
